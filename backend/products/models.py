...
class ItemDispensa(models.Model):
    ...
    familia = models.ForeignKey(Familia, on_delete=models.CASCADE, related_name='itens_dispensa')
    produto = models.ForeignKey(Produto, on_delete=models.CASCADE, related_name='itens_dispensa')
